...
- 會員課程內新增進階 81 格目標計畫表，但預設收合；必須先完成初階 9 格、點選最重要的一格、填完 What / Why / How 並保存，才能點「解鎖進階 81 格挑戰」展開。
...
- 可建立三件本週可以做的小行動。
- 可勾選行動完成狀態。
- 支援手機拍照或上傳照片，主要用來保存紙本九宮格、白板討論、便利貼或實作成果；若全程在網頁填寫，不一定需要上傳照片。
- 登入後完成初階 9 格、點選最重要的一格、填完 What / Why / How 並保存後，才可點「解鎖進階 81 格挑戰」，展開 81 格目標計畫表，把 9 格興趣線索延伸成能力、練習、資源、行動與作品證明。
